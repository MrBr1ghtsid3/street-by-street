...
{chr(10).join(path_elements)}
  ...
  <g>
    ...
    <text x="44" y="{VIEWBOX_HEIGHT - 42}" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="9" fill="#374151">Силистра (street-by-street пилот)</text>
