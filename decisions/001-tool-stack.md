...
street-by-street needs a working set of tools for field data collection, internal
...
- **Decidim** — an open-source participatory democracy platform. Rejected
  ...
  Worth reconsidering if street-by-street later needs structured resident participation
